...
class ResignationApplication extends StatefulWidget {
  const ResignationApplication({super.key});

  @override
  State<ResignationApplication> createState() => _ResignationApplicationState();
}

class _ResignationApplicationState extends State<ResignationApplication> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              const Text('Personal Email Address'),
              Padding(
                padding: const EdgeInsets.only(top: 8.0),
                child: TextField(
                  decoration: InputDecoration(
